 ...
 *
 * Real early-web and early-device output used low-pixel dimensions with
 * filtered sampling. Keeping the crop and fit math explicit makes smooth edge
 * handling easier in UI and worker code.
 */
